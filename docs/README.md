...
**Batch Maintenance**
For batch processing of the database such as bulk tag replacement  URL formatting or content interpolation by crawlers  please check the following. It is easy if you ask an AI agent to read it and generate a script.

**[📖 Maintenance Guide](../.agent/skills/nooklog-maintenance/SKILL.md)**
...
**[📖 Installation Guide](../.agent/skills/nooklog-maintenance/SKILL.md)**
